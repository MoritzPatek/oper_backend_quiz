"""
This module contains the views for the quiz app.
...
def create_user(request):
    ...
    Returns:
        Response: The response containing the created user.
    """
...
def create_quiz(request):
    """
    This view creates a new quiz.

    Returns:
        Response: The response containing the created quiz.
    """
...
def create_question(request):
    """
    This view creates a new question.

    Returns:
        Response: The response containing the created question.
    """
...
def create_answer(request):
    """
    This view creates a new answer.

    Returns:
        Response: The response containing the created answer.
    """
...
def create_answered_question(request):
    """
    This view creates a new answered question.

    Returns:
        Response: The response containing the created answered question.
    """
    user = request.user
    question_id = request.data.get("question_id")
...
def set_quiz_to_user(request):
    """
    This view assigns a quiz to a user.

    Returns:
        Response: The response containing the assigned quiz.
    """
...
def set_accepted_status(request):
    """
    This view updates the accepted status of a quiz.

    Returns:
        Response: The response containing the updated accepted status.
    """
    quiz_id = request.data.get("quiz_id")
...
def set_quiz_status(request):
    """
    This view updates the status of a quiz.

    Returns:
        Response: The response containing the updated status of the quiz.
    """
    quiz_id = request.data.get("quiz_id")
...
def get_user_quizzes(request):
    """
    This view retrieves all quizzes created by the user.

    Returns:
        Response: The response containing the quizzes created by the user.
    """
    user = request.user
...
def get_assigned_quizzes(request):
    """
    This view retrieves all quizzes assigned to the user.

    Returns:
        Response: The response containing the quizzes assigned
    """
    user = request.user
...
def get_quiz_statuses(request):
    """
    This view retrieves all quiz statuses.

    Returns:
        Response: The response containing all quiz statuses.
    """
...
def get_available_user_roles(request):
    """
    This view retrieves all available user roles.

    Returns:
        Response: The response containing all available user roles.
    """
...
def get_questions_by_quiz(request):
    """
    This view retrieves all questions for a specific quiz.

    Returns:
        Response: The response containing all questions for the quiz.
    """
...
def get_participant_quiz_progress(request):
    """
    This view retrieves the progress of a participant in a quiz.

    Returns:
        Response: The response containing the progress of the participant.
    """
    user = request.user
    quiz_id = request.query_params.get("quiz_id")  # Retrieve quiz_id from query parameters
    quiz = Quiz.objects.get(id=quiz_id)
        ...
        for answer in answers:
            ...
            if AnsweredQuestion.objects.filter(progress=user_progress, question=question, answer=answer).exists():
                ...
                if not answer.is_correct:
                    # If there is no AnsweredQuestion for this question, and the answer is not correct,
                    # then the user has answered the question correctly
                    correct_answers += 1
...
def get_quiz_scores(request):
    """
    This view retrieves the scores of all participants in a quiz.

    Returns:
        Response: The response containing the scores of all participants.
    """
    user = request.user
...
def get_next_question(request):
    """
    This view retrieves the next question for a user in a quiz.

    Returns:
        Response: The response containing the next question.
    """
    user = request.user
    quiz_id = request.query_params.get("quiz_id")
    quiz = Quiz.objects.get(id=quiz_id)
    ...
    if not user_progress:
        return Response({"error": "User does not have access to the quiz."}, status=status.HTTP_403_FORBIDDEN)
...
def get_answers_by_question(request):
    """
    This view retrieves all answers for a specific question.

    Returns:
        Response: The response containing all answers for the question.
    """
...
def get_all_users(request):
    """
    This view retrieves all users.

    Returns:
        Response: The response containing all users.
    """
